      ...
      const collegeSpecificResearch = "research/" + this.props.teams[0].id;
        return (
          <div className="team__container final__team">
            ...
            <img className="team__logo" src={this.props.teams[0].team.image ? this.props.home.team[0].image : "https://kipp-madness.herokuapp.com/bball-placeholder.png"} alt={this.props.teams[0].team.abbrev}></img>
