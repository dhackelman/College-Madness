      ...
      const collegeSpecificResearch = "research/" + champ.team.id;
        return (
          <div className="team__container the__champ">
            <Link to={collegeSpecificResearch}><FaInfoCircle className="team__info" className={!this.props.home.predicted_wins && this.props.round !== 'round_64' ? "is-hidden" : "team__info"}size={30}/></Link>
