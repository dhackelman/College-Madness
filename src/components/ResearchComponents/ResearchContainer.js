...
class ResearchContainer extends React.Component {
    ...
    getCollegeData() {
        axios.get("http://api.data.gov/ed/collegescorecard/").then(function(data) {
            console.log(data);
        });
    }
            ...
            <div className="research__container">
                ...
                <div className="research__start">
                    ...
                    <div className="college__basics">
                        ...
                        <p>Location:<span>Chapel Hill, NC</span>
                        </p>
                        <p>Mascot:<span>Ramses the Tar Heel</span>
                        </p>
                        <p>Mascot:<span>Ramses the Tar Heel</span>
                        </p>
                        <p>Colors:<span>Blue & White</span>
                        </p>
                        <p>Athletics:<span>Basketball, Baseball, etc.</span>
                        </p>
                    </div>
                </div>
